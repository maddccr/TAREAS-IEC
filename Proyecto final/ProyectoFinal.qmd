...
soluciones <- sols(60, 100, 1, 0.8) #r = pB - pD
#lines(t, sols, type = "l")
...
ggplot(coef_long, aes(x = valor)) +
  ...
  labs(x = "Valor del coeficiente", y = "Frecuencia",
       title = "Distribucion de los coeficientes de interpolacion") +
  theme(plot.title = element_text(size = 15, face = "bold", hjust = 0.5),
    legend.position = "right")
...
ggplot(df_dist_norm) +
  ...
  labs(title = "Distancia entre simulaciones", x="Distancia" , y= "Distribucion")
