...
ggplot(df_dist) +
  geom_histogram(aes(x=distancia), bins = 30, fill="skyblue") +
...
p_death_v<- c(seq(0, 0.25, by = 0.05), 
              seq(0.26, 0.35, by = 0.005),
              seq(0.36, 0.5, by =0.05))

res <- sens_paral(p_death = p_death_v)
```
